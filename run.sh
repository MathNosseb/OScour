...
if [ "$query" == "y" ]; then
    ...
    i386-elf-gcc -ffreestanding -m32 -g -O0 -c "Kernel/VGA.c" -o "Binaries/VGA.o"
    ...
    i386-elf-ld -o "Binaries/full_kernel.bin" -Ttext 0x1000 "Binaries/kernel_entry.o" "Binaries/request.o" "Binaries/keyboard.o" "Binaries/VGA.o" "Binaries/kernel.o" --oformat binary

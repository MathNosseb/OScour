...
gcc -m32 -ffreestanding -fno-pie -nostdlib -c kernel/output/vga.c    -o Binaries/vga.o
gcc -m32 -ffreestanding -fno-pie -nostdlib -c kernel/sys/struct.c    -o Binaries/struct.o
gcc -m32 -ffreestanding -fno-pie -nostdlib -c kernel/sys/string.c    -o Binaries/string.o
gcc -m32 -ffreestanding -fno-pie -nostdlib -c kernel/sys/hex.c    -o Binaries/hex.o
gcc -m32 -ffreestanding -fno-pie -nostdlib -c kernel/input/keyboard.c    -o Binaries/keyboard.o
gcc -m32 -ffreestanding -fno-pie -nostdlib -c kernel/app/shell.c    -o Binaries/shell.o
gcc -m32 -ffreestanding -fno-pie -nostdlib -c kernel/mem/mem.c    -o Binaries/mem.o
